  ...
  const projects = [
    {
      ...
      icon: <img src="/logos/github-logo.png" alt="Logo de Github" style={{ width: '24px', height: '24px' }} />,
    ...
    },
    {
      ...
      icon: <img src="/logos/node-logo.png" alt="Logo de Node.js " style={{ width: '24px', height: '24px' }} />,
    ...
    },
    {
      ...
      icon: <img src="/logos/vue-logo.png" alt="Logo du framework Vue" style={{ width: '24px', height: '24px' }} />,
    ...
    },
    {
      ...
      icon: <img src="/logos/django-logo.png" alt="Logo du framework Django" style={{ width: '24px', height: '24px' }} />,
    ...
    },
    {
      ...
      icon: <img src="/logos/symfony-logo.png" alt="Logo du framework Symfony" style={{ width: '24px', height: '24px' }} />,
