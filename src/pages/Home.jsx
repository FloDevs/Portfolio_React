        ...
        <div className="text-center w-full">
          ...
          <div className="h-8 md:h-10 mb-6">
            <h2 className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 font-medium">
              <span>{typedText}</span>
              <span className={isTypingComplete ? "hidden" : "animate-blink"}>
                |
              </span>
            </h2>
          </div>
          ...
          <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-8">
            Passionné par l'informatique en général, polyvalent et curieux, je
            m'adapte à divers langages et technologies, tout en ayant une
            affinité particulière pour les écosystèmes JavaScript et le
